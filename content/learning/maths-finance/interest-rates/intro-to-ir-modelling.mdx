...
**equity** counterparts. In the IR world, the underlying variable is an entire
term structure of interest rates, an unobservable quantity. Compare this to the 
equity world, where the underlying is often a single stock. IR models also lay 
claim to a **wider set of instruments**, both in the underlying and in the 
derivatives space. These instruments range from simple **government bonds** 
...
in which I work. I sit on the interest rates derivative trading desk at Barclays,
building and extending in-house models that the desk use for pricing and risk 
management. Accordingly, I feel comfortable weighing in on the existing 
