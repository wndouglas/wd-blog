...
and working in London. Whether it's maths and finance or my take on exercise,
...
known model used in the industry is the **Stochastic Alpha, Beta, Rho** model,
so named because of it's three governing Greek letter parameters: 
$\alpha$ (Alpha), $\beta$ (Beta) and $\rho$ (Rho).
